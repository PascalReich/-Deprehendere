...
def main(images, model_path, id_classifier_output_path, gen_classifier_output_path, batch_size, num_threads, override):
    ...
    classifier_filenames = [None, None]
...
"""
    ...
    with tf.Session(config=tf.ConfigProto(log_device_placement=False)) as sess:
        ...
        returns = _evaluate_classifier(emb_array, classifier_filenames)
...
def _load_images_and_labels(dataset, image_size, batch_size, num_threads, num_epochs, random_flip=False,
    ...
    dataset = filter_dataset(dataset, min_images_per_label=10)
...
def _evaluate_classifier(emb_array, classifier_filename):
